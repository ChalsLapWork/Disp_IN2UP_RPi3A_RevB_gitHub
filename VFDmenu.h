...
#ifndef HW_VER_2
#define HW_VER_2 3//[3||4] version 2.3 � 2.4
#endif
...
#define VERSION2 "v40.0.3.104"   //branch:RevE2 



/* static
los ADC se perdio la sincronia de los pulsos deSCLK cada 1mseg
 *             final=TT   VFD(LC) VFDmenu(LC) Memoria(LC) ADC(LC) DSP(LC)  Productdeanager(LC)  lineas de codigo=LC[.c,.h] tama�o total =TT(bytes)
 ...
 *  v36.1.0-73   10-NOV-16: sem43: Desarrollo d3spliegue de la se�	al en DDS, 
 ...
 *   v39.2.0     3-FEB-17  correccion del acondicionamiento de se�al del DSP,
 ...
 *  39.13.16.0-35 11-Agt-17, continuar con el angulo de vibraci�n con nueva version.    
 ...
 *  v39.13.21.174   9-OCT-18, Un a�o despues, que nos dejaron seguir con el codigo, 
 ...
 *                           vamos a poner un mejor control de DDS y ha revisar el DDSdisplay en que me quede hace mas de un a�o                         
 ...
 *                             rene nos hablo a 
 *                            junta y no se alcanzo a guardar proyecto y se da�o el target no 
 ...
 * v39.15.8.0-322  26-Nov-19  140996,se hizo el menu de control de contrase�as con tdo su manejo de memoria.
 ...
 * v39.16.22.0-20      27-Mar-20, conectar la se�al al DDS y al analisador de deteccion.                                                                          
 ...
 * v39.16.26-0-137     1-jun-20 poner el DDS con se�al real. Avanze en la se�al offset
 ...
 *                       Ya funciona con ssistema operativo el borrado deL DDS sin erres de characteres en display        
  ...
  v39.16.34.0            30-OCt-20  empezamos a dise�ar el procesador de graficos que un nueva 
 ...
 *v39.16.34.0-74         30-OCt-20  empezamos a dise�ar el procesador de graficos que un nueva 
                            version de como desplegar en el display usando el sistema operativo
...
*                     sigue generar cuadros y luego cambiarlos de tama�o usando el zoom
...
*                                 pero todavia no estan listos, se hizo el driver control principal de video � graficacion
...
*   "v39.22.10.104"   21-nov-23   ya dibuja la deteccion en Desktop, la se�al no se centra bien todavia en el DSP, todavia no
*                                  desplegamos puntos en DDS porque no se centra bien.
*                        
*     "v39.22.11.12"   29-Nov-23  vamos a empezar a hacer pruebas con el zoom
...
//*************KONSTANTES_DE_MENU_++++++++++++++++++++++++++++++++++++++++++++++++++++
#define ESTAS_SEGURO                          0x18U//Se necesitan los bits MSB contexto que pregunta antes de guardar
#define TEXT_PROCESSOR                        0x19U
#define ANTERIOR_MENU                         0x20U
...
#define POSXCTA                    192 //posicion de "APAGA" � "PERMITIR" de cuenta de producto en informacion de usuario en menu insight       
#define POSX192                    192 
#define POSX185                    185
...
#define POSXDDSCURSUBMENU          206 //POSICION del cursor se�alando intervencion en el valor del parametro   >00000
...
//#define SIZE_GRAPH_X               25 //tama�o del controlador graphico de pixeles
//#define SIZE_GRAPH_Y               16 //tama�o de Y del controlador graphico array
...
struct ArbolMenu{
    ...
    unsigned char (*func2)(unsigned char*);//ya con SO
